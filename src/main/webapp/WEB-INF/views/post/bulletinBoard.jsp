...
<body>
  <div id="jstree"></div>        
  <div>게시판 글 작성</div>
  <form id="p_frm" method="post" enctype="multipart/form-data" ">
      <div>
      ...
      <div>
        ...
        <input type="text" id="u_mail" name="u_email"/>
      </div>
      <div>
      ...
      <button onclick="publishPost(event);">작성</button>
  </form>
</body> 